			...
			<table>
				...
				<tbody>
					<tr>
						<th>이름</th>
						<td>
							<input class="w-full input input-bordered  max-w-xs" name="name" type="text" placeholder="이름을 입력하세요" />
						</td>
					</tr>
					<tr>
						<th>이메일</th>
						<td>
							<input class="w-full input input-bordered  max-w-xs" name="email" type="text" placeholder="이메일을 입력하세요" />
						</td>
					</tr>
					<tr>
						<th></th>
