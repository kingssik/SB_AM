			...
			<table class="table table-zebra w-full">
				...
				<tbody>
					...
					<tr>
						<th>새 비밀번호</th>
						<td>
							<input name="loginPw" class="w-full input input-bordered  max-w-xs" placeholder="새 비밀번호를 입력하세요" />
						</td>
					</tr>
					<tr>
						<th>새 비밀번호 확인</th>
						<td>
							<input name="loginPwConfirm" class="w-full input input-bordered  max-w-xs" placeholder="새 비밀번호를 입력하세요" />
						</td>
					</tr>
					<tr>
						<th>이름</th>
					...
					<tr>
						...
						<td>
							<input value="${rq.loginedMember.cellphoneNum }" name="cellphoneNum"
								class="w-full input input-bordered max-w-xs" placeholder="전화번호를 입력하세요"
							/>
						</td>
					</tr>
					<tr>
